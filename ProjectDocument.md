...
[Gameplay Testing Feedback](https://docs.google.com/spreadsheets/d/1a0zdnXxHbPygx5iRfNc8mrMcdwVIZvbrHI-Lod_RALg/edit?usp=sharing)
(This is a condensed version of the questions provided since most of the feedback was saying the things mentioned in the link above)

### Key Findings
During our initial round of gameplay testing, our level was very bare bones and the only thing showcased was the movement. Because of this, almost all of our feedback was regarding the nuances of our movement.

From this round of testing, we discovered that our movement needed a fair amount of refinement. The most common criticism of this gameplay system was the feel. More specifically, our horizontal movement felt very slippery as if the player was moving on ice. Something else that was noticed was that there were some inconsistencies in the movements. Sometimes quickly changing directions would behave as intended and sometimes movement was cancelled all together. These types of bugs were noted and were placed on the top of our priorities list to fix after they were reported to us. 

We also discovered during this round of testing that we also had to prioritize the completion of our level. We realized through the gameplay testers that suggesting revisions would be fruitless if all we had was an empty stage. From this we learned that the design of the level plays a major role in the “feel” of the movements. For example, slipperiness would be idea for an ice level but not so much for a city-themed level. One gameplay tester had mentioned to us that they could not give us any revision ideas because they did not know how the game was intended to be played. This made us realize that we had to have more than an empty scene with a platform in order to get more meaningful feedback.

Our post-revision gameplay testing still yielded issues with movement but the suggested changes were not as major as the initial testing phase. In this phase of testing, with the level complete, more thorough testing was done. The testers during this phase were thorough and tested with the intent to try to break the game. While observing their gameplay and getting their feedback, we discovered that our code at the time was not well-suited for Unity physics and was subsequently changed to fix the issues.

The mapping of our inputs was also topic of discussion because of the testing. Many players used many different input paradigms for their movements. Some used `WASD` for their movements, others used the arrows keys. Some just used `Space` to jump while others used the up direction for whatever input method they defaulted to. We discussed what to set our input paradigm to but we ultimately decided to allow all combinations used by our gameplay testers by basing our movements on Unity's input mappings rather than hard-coding keys. 
